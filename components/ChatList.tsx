                        ...
                        <span
                          className={`flex-shrink-0 rounded-full border px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide ${
                            chat.otherUserType === "coach"
                              ...
                              : chat.otherUserType === "admin"
                                ? "bg-amber-50 border-amber-200 text-amber-700 hidden sm:inline-flex"
                                : chat.otherUserType === "mentor"
                                  ? "bg-indigo-50 border-indigo-200 text-indigo-600 hidden sm:inline-flex"
